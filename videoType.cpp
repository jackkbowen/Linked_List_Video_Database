...
void videoType::setVideoInfo(string title, string starl, string star2, string producer, string director, string productionCo, int setInStock)
{
    videoTitle = title;
    movieStar1 = starl;
    movieStar2 = star2;
...
videoType::videoType(string title, string starl, string star2, string producer, string director, string productionCo, int setInStock)
{
    setVideoInfo(title, starl, star2, producer, director, productionCo, setInStock);
}
